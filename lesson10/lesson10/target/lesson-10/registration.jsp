							...
							<form class="register-form">
								<div class="mb-3">
									<input class="form-control firstName" type="text" required
										autofocus placeholder="Ім’я" name="firstname" autocomplete="name">
								</div>
								<div class="mb-3">
									<input class="form-control lastName" type="text"
										placeholder="Прізвище" required autofocus name="lastname" autocomplete="name">
								</div>
								<div class="mb-3">
									<input class="form-control email" type="email"
										placeholder="E-Mail" required name="email" autocomplete="email">
								</div>
								<div class="mb-3">
									<input class="form-control password" type="password"
										placeholder="Пароль" required name="password" autocomplete="current-password">
								</div>
								<div class="mb-3">
									<input class="form-control cpassword" type="password"
										placeholder="Повторіть пароль" required name="cpassword" autocomplete="current-password">
								</div>
